...
/**
 * GUI interface for a {@link DiffAssertion}.
 *
 */
public class DiffAssertionGui extends AbstractAssertionGui {
    ...
    public TestElement createTestElement() {
        DiffAssertion el = new DiffAssertion();
    ...
    public void modifyTestElement(TestElement el) {
        ...
        if (el instanceof DiffAssertion) {
            DiffAssertion ra = (DiffAssertion) el;
    ...
    public void configure(TestElement el) {
        super.configure(el);
        DiffAssertion model = (DiffAssertion) el;
