...
public class Proxy extends Thread {
    ...
    private ProxyControlDummy target;

    /** Whether or not to capture the HTTP headers. */
    private boolean captureHttpHeaders;

    /** Reference to Deamon.java's Map of url string to page character encoding of that page */
    private Map<String, String> pageEncodings;
    /** Reference to Deamon.java's Map of url string to character encoding for the form */
     ...
     *            reference to the Map of Deamon.java, with mappings from page urls to encoding used
     * @param _formEncodings
     *            reference to the Map of Deamon.java, with mappings from form action urls to encoding used
     */
    void configure(Socket _clientSocket, ProxyControlDummy _target, Map<String, String> _pageEncodings, Map<String, String> _formEncodings) {
        this.target = _target;
    ...
    private SSLSocketFactory getSSLSocketFactory(String host) {
        ...
        switch(ProxyControlDummy.KEYSTORE_MODE) {
            ...
            case JMETER_KEYSTORE:
                hashAlias = keyAlias = ProxyControlDummy.JMETER_SERVER_ALIAS;
                break;
            case USER_KEYSTORE:
                hashAlias = keyAlias = ProxyControlDummy.CERT_ALIAS;
                break;
            default:
                throw new IllegalStateException("Impossible case: " + ProxyControlDummy.KEYSTORE_MODE);
        }
